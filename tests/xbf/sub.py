...
def test_simple_sub() -> None:
    a = xbf.Unit()
    commands = [xbf.InitUnit(a), xbf.SubUnit(a, 100, a)]
...
def test_sub_from_itself() -> None:
    a = xbf.Unit()
    commands = [xbf.InitUnit(a), xbf.SubUnit(a, 10, a), xbf.SubUnit(a, a, a)]
...
def test_sub() -> None:
    ...
    commands = [xbf.InitUnit(a), xbf.InitUnit(b), xbf.SubUnit(a, 10, a), xbf.SubUnit(b, a, b), xbf.SubUnit(b, 5, b)]
